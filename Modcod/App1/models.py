...
class Project(models.Model):
    ...
    montant_caution = models.DecimalField(max_digits=50, decimal_places=2,default=0.00)
    estimation_projet = models.DecimalField(max_digits=50, decimal_places=2,default=0.00)
